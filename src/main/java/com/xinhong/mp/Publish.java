...
public class Publish {
    ...
    private static final String user = ConfigDownload.getApollo_user();
    private static final String password =  ConfigDownload.getApollo_password();
    private static final String host = ConfigDownload.getApollo_host();
    private static final int port = Integer.parseInt(ConfigDownload.getApollo_port());
